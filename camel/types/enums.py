...
class ModelType(UnifiedModelType, Enum):
    ...
    OPENROUTER_QWEN_PLUS = 'qwen/qwen-plus'
    OPENROUTER_QWEN_VL_MAX = 'qwen/qwen-vl-max'
    ...
    def is_openrouter(self) -> bool:
        ...
        return self in {
            ...
            ModelType.OPENROUTER_GROK_4_FAST,
            ModelType.OPENROUTER_GEMINI_2_5_FLASH,
            ModelType.OPENROUTER_GPT_4O_MINI,
            ModelType.OPENROUTER_QWEN_PLUS,
            ModelType.OPENROUTER_QWEN_VL_MAX,
            ModelType.OPENROUTER_o3,
            ModelType.OPENROUTER_CLAUDE_SONNET_4_5
        }
